...
// lobby do ponto de vista do mestre da partida
@Composable
fun MasterLobbyScreen(
    ...
    Layout(
        compactContent = {
            CompactMasterLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        mediumContent = {
            MediumMasterLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        expandedContent = {
            ExpandedMasterLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
...
fun CompactMasterLobbyScreen(
    ...
    Column(
        ...
        Text(text = "Você está na MasterLobbyScreen")
