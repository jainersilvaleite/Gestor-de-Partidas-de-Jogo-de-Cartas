...
// visão da partida pelo seu mestre
@Composable
fun MasterMatchScreen(
    ...
    Layout(
        compactContent = {
            CompactMasterMatchScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        mediumContent = {
            MediumMasterMatchScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        expandedContent = {
            ExpandedMasterMatchScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
...
fun CompactMasterMatchScreen(
    ...
    Column(
        ...
        Text(text = "Você está na MasterMatchScreen")
