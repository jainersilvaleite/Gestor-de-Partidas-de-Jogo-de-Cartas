...
// lobby do ponto de vista dos jogadores
@Composable
fun PlayerLobbyScreen(
    ...
    Layout(
        compactContent = {
            CompactPlayerLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        mediumContent = {
            MediumPlayerLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        expandedContent = {
            ExpandedPlayerLobbyScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
...
fun CompactPlayerLobbyScreen(
    ...
    Column(
        ...
        Text(text = "Você está na PlayerLobbyScreen")
