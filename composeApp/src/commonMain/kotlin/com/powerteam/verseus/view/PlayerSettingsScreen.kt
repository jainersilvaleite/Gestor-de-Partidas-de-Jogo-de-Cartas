...
// ajustes dos dados de um jogador pelo mestre da partida
@Composable
fun PlayerSettingsScreen(
    ...
    Layout(
        compactContent = {
            CompactPlayerSettingsScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        mediumContent = {
            MediumPlayerSettingsScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
        expandedContent = {
            ExpandedPlayerSettingsScreen(
                onNavigate = onNavigate,
                modifier = modifier
            )
        },
...
@Composable
fun CompactPlayerSettingsScreen(
    onNavigate: (Screen) -> Unit,
    modifier: Modifier = Modifier
) {
    Column(
        ...
        Text(text = "Você está na PlayerSettingsScreen")
...
@Composable
fun MediumPlayerSettingsScreen(
    onNavigate: (Screen) -> Unit,
    modifier: Modifier = Modifier
) {
    Column(
...
@Composable
fun ExpandedPlayerSettingsScreen(
    onNavigate: (Screen) -> Unit,
    modifier: Modifier = Modifier
) {
    Column(
